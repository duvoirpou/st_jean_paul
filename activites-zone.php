                    ...
                    < class="sidebar col-md-4">
                        <aside>
                            ...
                            <div class="sidebar-item category">
                                <div class="title">
                                    <h4>categorie d'activité</h4>
                                </div>
                                <div class="sidebar-info">
                                    <ul>
                                        <li>
                                            <a href="scolaire.php">Scolaire <span>69</span></a>
                                        </li>
                                        <li>
                                            <a href="culturelle.php">Culturelle <span>25</span></a>
                                        </li>
                                        <li>
                                            <a href="pratique.php">Pratique <span>18</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
