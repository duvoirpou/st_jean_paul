...
<body>
    ...
    <div class="breadcrumb-area shadow text-center dark bg-fixed text-light" style="background-image: url(assets/img/cathedrale.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Semaine diplomatique</h1>
                    <ul class="breadcrumb">
                        <li><a href="#"><i class="fas fa-home"></i>Acceuil</a></li>
                        <li><a href="#">Pages</a></li>
                        <li class="active">Se.diplo</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="blog-items">
                    <div class="blog-content col-md-8">
                        ...
                        <div class="single-item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="assets/img/IMG-20240807-WA0034.jpg" alt="Thumb">
                                </a>
                                <div class="meta">
                                        <li>
                            ...
                            <div class="info">
                                ...
                                <p>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut deserunt hic nesciunt corrupti debitis maxime sint unde dolor? Dolore recusandae voluptatum expedita officiis facere earum repellendus quas fugit exercitationem? Iure.
                                </p>
                            </div>
                        </div>
                        <!-- End Single Item -->
                        ...
                        <div class="single-item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="assets/img/IMG-20240807-WA0036.jpg" alt="Thumb">
                                </a>
                                <div class="meta">
                            ...
                            <div class="info">
                                ...
                                <p>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis repudiandae corrupti atque facere architecto, adipisci quo. Molestiae earum autem tenetur dolores quo quas magni ea iusto quisquam similique, quidem a. 
                                </p>
                        ...
                        <div class="single-item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="assets/img/IMG-20240807-WA0044.jpg" alt="Thumb">
                                </a>
                                <div class="meta">
                                    
                                        <li>
                                            <a href="#"><i class="fas fa-calendar-alt"></i> 15 Sep, 2019</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="info">
                                ...
                                <p>
                                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Porro optio expedita velit obcaecati? Natus quibusdam consectetur repellat aliquam corrupti, quae suscipit nisi adipisci debitis cumque ut, exercitationem illum quasi reiciendis.
                                </p>
                            </div>
                        </div>
                        <!-- End Single Item -->
                        ...
                        <aside>
                            ...
                            <div class="sidebar-item category">
                                ...
                                <div class="sidebar-info">
                                    <ul>
                                        <li>
                                            <a href="gallery.php">Notre gallery<span></span></a>
                                        </li>
                                        <li>
                                            <a href="chef.php">Nos chefs<span></span></a>
                                        </li>
                                        <li>
                                            <a href="realisation.php">Nos réalisation<span></span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <!-- <div class="sidebar-item recent-post">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="info">
                                            <a href="#">Meetingness manage dedicated</a>
