...
if (isset($_POST['ajouter'])) {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
            ...
            $sql = "INSERT INTO `actualites`(`titre`, `description`, `type_actualite_id`, `filename`) VALUES ('$titre','$description','$type_actualite_id', '$filename')";
...
$requete = $bdd->prepare("SELECT * FROM `actualites` WHERE 1");
$requete->execute();
...
<br><br><br>
        ...
        <div class="bg14"><h3>Ajouter un utilisateur</h3></div>
        ...
        <div class="bg9">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group">
                        <div class="bg10"><label for="titre"><b>Titre</b></label></div>
                        <input type="text" class="bg32" id="titre" name="titre" required>
                    </div>
                    <br>
                    <div class="input-group">
                        <div class="bg11"><label for="description"><b>Description</b></label></div>
                        <textarea name="description" id="" cols="30" rows="10" required></textarea>
                    </div>
                    <br>
                    <div class="input-group">
                        <div class="bg00"><label for="filename"><b>Filename</b></label></div>
