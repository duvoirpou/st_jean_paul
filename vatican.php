...
<body>
    ...
    <!-- Start Breadcrumb 
    ============================================= -->
    <div class="breadcrumb-area shadow text-center dark bg-fixed text-light" style="background-image: url(assets/img/cathedrale-du-sacre-coeur-a-brazzaville-30-novembre-2015-2rcxxrd.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Notre partenaire</h1>
                    <ul class="breadcrumb">
                        <li><a href="#"><i class="fas fa-home"></i> Acceui</a></li>
    ...
    <div class="basic-info-area text-center default-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 single-item">
                    <div class="item">
                        <h4>Recevez une offre</h4>
                        <p>
                            Abonnez-vous aujourd'hui et recevez une offre tous les jours. C'est facile et ne prend que quelqus minutes !
                        </p>
                        <form action="#">
