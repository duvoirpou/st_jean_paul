            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right" data-in="#" data-out="#">
                        <li class="dropdown">
                            <a href="index.php" class="dropdown-toggle" data-toggle="dropdown" >Acceuil</a>
                        </li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" >Pages</a>
                            <ul class="dropdown-menu">
                                <li class="dropdown">
                                    <a href="about.php" class="dropdown-toggle" data-toggle="dropdown" >A propos de nous</a>
                                </li>
                        ...
                        <li class="dropdown">
                            <a href="menu.php" class="dropdown-toggle active" data-toggle="dropdown" >Réalisation</a>
                        </li>  
                        <li class="dropdown">
                            <a href="gallery-grid-3-colum.php" class="dropdown-toggle active" data-toggle="dropdown" >Activité</a>
                        </li>
                        <li class="dropdown">
                            <a href="blog-single-right-sidebar.php" class="dropdown-toggle" data-toggle="dropdown" >Blog</a>
                        </li>
                        <li>
