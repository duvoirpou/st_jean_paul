...
$requete = $bdd->prepare("SELECT activites.id, activites.titre, activites.description, activites.type_activite_id, activites.filename, type_activites.id AS id_type_activite, type_activites.nom FROM `activites` JOIN type_activites ON activites.type_activite_id = type_activites.id WHERE type_activites.id = 2");
$requete->execute();
            ...
            <div class="row">
                ...
                <div class="blog-content col-md-10 col-md-offset-1">
                        ...
                        <!-- <div class="single-item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="assets/img/remise.png" alt="Thumb">
                                </a>
                            </div>
                            <div class="info">
                                <h3>
